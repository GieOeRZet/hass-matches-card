 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function ft(t){return pt({...t,state:!0,attribute:!1})}let gt=(()=>{let i,n,r,o,a=[lt("matches-card-editor")],c=[],l=ht,d=[],u=[],p=[],f=[];return n=class extends l{setConfig(t){this.config={...t}}render(){return this.hass&&this.config?W`
