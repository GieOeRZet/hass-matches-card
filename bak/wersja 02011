// ============================================================================
//  Matches Card (90minut) – v0.2.011
//  Autor: GieOeRZet
//  Repozytorium: https://github.com/GieOeRZet/matches-card
//
//  Nowości:
//  - Nowy parametr `fill_mode`: gradient | zebra | none
//  - Separator między wierszami zawsze włączony
//  - Opcja `show_result_symbols: true/false` niezależna od fill_mode
//  - Zachowany cały poprzedni layout (jak w 0.2.010)
// ============================================================================
...
class MatchesCard extends HTMLElement {
  setConfig(config) {
    ...
    this.config = {
      ...
      show_result_symbols: true, // nowe pole
